...
public class BlogListActivity extends ListActivity implements TaskListener {
	...
	if (getAuthToken()) {
	    ...
	    service = new com.google.api.services.blogger.Blogger.Builder(HTTP_TRANSPORT, JSON_FACTORY, credential).setJsonHttpRequestInitializer(new GoogleKeyInitializer(ClientCredentials.KEY))
